                            ...
                            <div class="container-fluid m-0 p-0">
                                <div class="row m-0 p-0">
                                    ...
                                    <div class="col-md-4 p-2">
                                        ...
                                        <input id="cpassword" v-model="form.confirmPassword" placeholder="Confirm Password" class="form-control" type="password" />
                                    </div>
...
// Form data object including profile picture
const form = useForm({
    name: "",
    email: "",
    mobile: "",
...
function submit() {
    if (form.name.length === 0) {
        ...
        // Form data with profile picture
        const formData = new FormData();
        formData.append('name', form.name);
        formData.append('email', form.email);
        formData.append('mobile', form.mobile);
        formData.append('password', form.password);
        formData.append('profile_pic', form.profilePicture); // Append the profile picture
